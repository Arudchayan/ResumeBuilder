  ...
  return (
    <div className="space-y-1">
      <textarea
        ...
        className={`rb-textarea w-full min-h-[90px] rounded-lg border px-3 py-2 text-sm outline-none focus:ring-0 ${error ? 'border-red-300 focus:ring-red-300' : 'border-slate-200'} ${className}`}
      />
      {(error || helperText) && (
